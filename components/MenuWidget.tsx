...
const MenuWidget = () => {
  return (
    <div className="w-[300px] border-4 border-[#C3BCBC] rounded-lg overflow-hidden gap-0 bg-white">
      <h2 className="bg-[#D9D9D9] text-gray-800 py-1 px-4 m-0 text-[30px] font-jaro flex justify-between items-center text-center relative">
        <div className="flex justify-center items-center w-full">
          IMM2025
        </div>
        <div className="absolute right-4 top-1/2 -translate-y-1/2 flex justify-between items-center">
